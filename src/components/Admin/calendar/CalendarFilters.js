...
const CalendarFilters = ({ filters, setFilters }) => {
  return (
    <div className="bg-white p-4 shadow rounded-xl border border-gray-100 mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
        <div>
          ...
          <input
            ...
            className="border border-gray-300 p-2 rounded-lg w-full focus:ring-purple-500 focus:border-purple-500"
          />
        </div>
        <div>
